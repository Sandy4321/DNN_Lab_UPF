...
class LogisticRegression:
	...
	def init(self):
		...
		self.W = self.init_weights((self.n_inputs, self.n_classes))
		self.b = theano.shared(value=self.floatX(np.zeros((self.n_classes,))), borrow=True)
